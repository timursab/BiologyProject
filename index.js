...
document.getElementById("submit").onclick = function(){
    ...
    if (selectedfood == null){
        ...
        calories.insertAdjacentText('beforeend',"Calories = "+Math.round(portion*3.05)+"gr\n")
    ...
    if(selectedfood == 1){
        calories.insertAdjacentText('beforeend',"Calories ="+Math.round(portion*2.55)+"gr\n")
    ...
    if(selectedfood == 2){
        calories.insertAdjacentText('beforeend',"Calories ="+Math.round(portion*1.31)+"gr\n")
